...
const Sidebar = () => {
    ...
    return (
        <div className=' w-[200px] p-5 items-center gap-2 bg-white h-screen sticky top-0 z-10 shadow-blue-200 shadow-md '>
            ...
            <button onClick={() => document.getElementById('my_modal_3').showModal()} className=' w-[150px] flex mt-3 gap-5 text-[15px] items-center text-white bg-sky-400 p-2 rounded-sm hover:scale-105 '>  New Folder
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
